      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative animate-scale-in">
            ...
            {/* Floating stat cards */}
            <div className="absolute -bottom-6 -left-4 sm:-left-6 bg-card border border-border rounded-xl p-3 sm:p-4 shadow-strong backdrop-blur-sm animate-fade-in">
              <div className="text-2xl sm:text-3xl font-bold text-primary">4.9★</div>
              <div className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap">Avg Rating</div>
            </div>
            
            <div className="absolute -top-6 -right-4 sm:-right-6 bg-card border border-border rounded-xl p-3 sm:p-4 shadow-strong backdrop-blur-sm animate-fade-in">
              <div className="text-2xl sm:text-3xl font-bold text-primary">85%</div>
              <div className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap">More Reviews</div>
            </div>
          </div>
        </div>
      </div>
